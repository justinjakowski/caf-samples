...
![Migration process](/media/wmware-to-azure-migration-scenario/onpremises-stretched-network-expressroute.png)
...
- The VMs are then replicated and moved to Azure using VMware HCX.
    ...
    ![Migration process](/media/wmware-to-azure-migration-scenario/onpremises-vmwarehcx-azure.png)
...
>Note:  Azure VMware Solution is available in the US East, US West, and West Europe regions.
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-cloudsimple.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-cloudsimple-step1.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-privatecloud.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-privatecloud-step1.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/new-vpn-gateway.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/download-vpn-configuration.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-vlan-subset.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/create-vlan-subset-step1.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/vsphere-management-network-private-cloud.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/expressroute-authorization.png)
...
![Migration process](/media/wmware-to-azure-migration-scenario/hcx-manager.png)
