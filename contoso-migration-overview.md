...
**Article** | **Details**
--- | ---
[VMware: Moving on-premises infrastructure to Azure](https://github.com/deltadan/caf-samples/blob/master/vmware-to-azure-migration-scenario.md) | This article provides an example ofmoving an on-premises VMware VMs to Azure using Azure VMware Solutions.
